...
namespace webwork::expression {
    std::shared_ptr<const Property> LogicNegationOperator::CalculatePrefix(const std::shared_ptr<const Property> &prop, const std::shared_ptr<const properties::Scope> &) const {
